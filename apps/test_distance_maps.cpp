...
// TEST DRAW distance maps using LSD and CANNY EDGE DETECTOR
using namespace std;
using namespace cv;
...
int main(int argc, char **argv)
{
  ...
  lsd_edge_detector.setNumEdgeDirections(60);// 5 degree changes
  lsd_edge_detector.setImage(src_img);
  lsd_edge_detector.getEdgeMap(edge_map);//gray
  //just edges
