...
template < typename _Ti , typename _To  > inline 
  _To tensorGetPix ( const ImageTensor &tensor, 
...
template < typename _Ti , typename _To  > inline 
  _To tensorbilinearInterp ( const ImageTensor &tensor, 
                             const _To &x, const _To &y, const _To &z, 
                             bool cyclic_z = true )
{
...
template < typename _Ti, typename _To, typename _Tj, int _Nj > inline
  ceres::Jet<_Tj, _Nj> tensorGetPix ( const ImageTensor &tensor,
                                      const ceres::Jet<_Tj, _Nj> &x, 
                                      const ceres::Jet<_Tj, _Nj> &y,
...
template < typename _Ti, typename _To, typename _Tj, int _Nj > inline
  ceres::Jet<_Tj, _Nj> tensorbilinearInterp ( const ImageTensor &tensor,
                                              const ceres::Jet<_Tj, _Nj> &x, 
                                              const ceres::Jet<_Tj, _Nj> &y,
                                              const ceres::Jet<_Tj, _Nj> &z,
                                              bool cyclic_z = true )
